...
public class TabAdapterMain extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0 : { return TabOne.newInstance(); }
            case 1 : { return TabTwo.newInstance(); }
            default : { return TabThree.newInstance(); }
        }
    }
    ...
    public CharSequence getPageTitle(int position) {
        switch (position) {
            case 0 : { return "Tab Satu"; }
            case 1 : { return "Tab Dua"; }
            default : { return "Tab Tiga"; }
        }
    }
}
